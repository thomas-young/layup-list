...
class TermsTestCase(TestCase):
    def test_term_regex_works_in_common_case(self):
        ...
        self.assertTrue(
            term_data and term_data.group('year') == '16'
    ...
    def test_term_regex_allows_for_current_term(self):
        ...
        self.assertTrue(
            term_data and term_data.group('year') == constants.CURRENT_TERM[:2]
    ...
    def test_numeric_value_of_term_ranks_terms_in_correct_order(self):
        correct_order = [
            '', '09w', '09S', '09X', '12F', '14x', '15W', '16S', '20x'
        ]
    ...
    def test_is_valid_term_returns_false_if_in_future(self):
        next_year = int(
            terms.term_regex.match(constants.CURRENT_TERM).group('year')) + 1
